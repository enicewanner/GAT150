...
void nae::SpriteAnimComponent::Update()
{
...
void nae::SpriteAnimComponent::Draw(Renderer& renderer)
{
    renderer.Draw(m_texture, source, m_owner->m_transform);
}

bool nae::SpriteAnimComponent::Write(const rapidjson::Value& value) const
{
    return true;
}

bool nae::SpriteAnimComponent::Read(const rapidjson::Value& value)
{
